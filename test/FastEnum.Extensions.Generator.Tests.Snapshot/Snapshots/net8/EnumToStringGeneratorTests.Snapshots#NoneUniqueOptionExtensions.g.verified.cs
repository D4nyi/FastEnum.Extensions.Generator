...
public static class NoneUniqueOptionExtensions
{
    ...
    public static string? GetEnumMemberValue(this SnapshotTesting.NoneUniqueOption value) => value switch
    {
    ...
    public static string? GetDisplayName(this SnapshotTesting.NoneUniqueOption value) => value switch
    {
    ...
    public static string? GetDisplayDescription(this SnapshotTesting.NoneUniqueOption value) => value switch
    {
        SnapshotTesting.NoneUniqueOption.Parse => "Parse",
        _ => null
    };
    ...
    public static string? GetDescription(this SnapshotTesting.NoneUniqueOption value) => value switch
    {
